...
//     return userDocSnap.exists() ? userDocSnap.data().customUID : null;
// }
...
// async function checkCartStatus() {
//     const customUID = await getCustomUID();
//     if (!customUID) return;

//     const cartRef = collection(db, `Users/${customUID}/Cart`);
//     const cartSnapshot = await getDocs(cartRef);
...
//         const cartItemRef = doc(db, `Users/${customUID}/Cart/${productId}`);
